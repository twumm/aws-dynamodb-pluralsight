...
//   let key = generateJobApplicationKey(job, user)
...
//     let job = generateUniqueJob()

//     let numberOfJobAppplications = faker.random.number({
//       'min': 0,
//       'max': numberOfUsers
//     })

//     for (let applications=0; applications<numberOfJobAppplications; applications++) {
...
//     'GMJS.User': users,
//     'GMJS.Job': jobs,
//     'GMJS.JobApplication': jobApplications
//   }
